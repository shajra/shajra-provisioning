pkgs: {
  ...
  # REVISIT: 2026-05-23: BLOCKED: Note emacs-macport doesn't have native compilation
  ...
  # REVISIT: 2026-05-23: CHECKED: Periodically confirm matching the latest recommended
