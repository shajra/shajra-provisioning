pkgs: {
  ...
  # REVISIT: 2026-03-01: BLOCKED: Note emacs-macport doesn't have native compilation
  ...
  # REVISIT: 2026-03-01: CHECKED: Periodically confirm matching the latest recommended
