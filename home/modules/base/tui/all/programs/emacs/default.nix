pkgs: {
  ...
  # REVISIT: 2026-07-01: BLOCKED: Note emacs-macport doesn't have native compilation
  ...
  # REVISIT: 2026-07-01: REPEATING: Periodically confirm matching the latest recommended
