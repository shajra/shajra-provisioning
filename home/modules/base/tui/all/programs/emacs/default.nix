pkgs: {
  ...
  # REVISIT: 2026-03-05: BLOCKED: Note emacs-macport doesn't have native compilation
  ...
  # REVISIT: 2026-03-05: CHECKED: Periodically confirm matching the latest recommended
