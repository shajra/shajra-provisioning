pkgs: {
  ...
  # REVISIT: 2026-05-09: BLOCKED: Note emacs-macport doesn't have native compilation
  ...
  # REVISIT: 2026-05-09: CHECKED: Periodically confirm matching the latest recommended
