pkgs: {
  ...
  # REVISIT: 2026-08-12: BLOCKED: Note emacs-macport doesn't have native compilation
  ...
  # REVISIT: 2026-08-12: REPEATING: Periodically confirm matching the latest recommended
