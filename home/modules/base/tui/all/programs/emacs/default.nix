pkgs: {
  ...
  # REVISIT: 2026-04-12: BLOCKED: Note emacs-macport doesn't have native compilation
  ...
  # REVISIT: 2026-04-12: CHECKED: Periodically confirm matching the latest recommended
