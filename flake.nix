{
    ...
    inputs = {
        ...
        sf-symbols             = { url = "https://devimages-cdn.apple.com/design/resources/download/SF-Symbols-7.dmg"; flake = false; };
        sketchybar             = { url = "github:FelixKratz/SketchyBar"; flake = false; };
        sketchybar-font-dist   = { url = "https://github.com/kvndrsslr/sketchybar-app-font/releases/download/v2.0.39/sketchybar-app-font.ttf"; flake = false; };
