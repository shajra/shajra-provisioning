{
  ...
  inputs = {
    ...
    sketchybar-font-dist = {
      url = "https://github.com/kvndrsslr/sketchybar-app-font/releases/download/v2.0.55/sketchybar-app-font.ttf";
      flake = false;
    };
    sketchybar-font-src = {
          ...
          in
          {
            ...
            devshells.default =
              ...
              in
              {
                commands = [
                  {
                    # REVISIT: 2026-03-05: FIXABLE? Bootstrap is incomplete
