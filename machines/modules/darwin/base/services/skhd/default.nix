...
in
{
  ...
  skhdConfig = ''
    ...
    # REVISIT: 2026-04-12: BLOCKED: Return all references to cmd back to lcmd
    ...
    # REVISIT: 2026-04-12: FIXABLE? move workspace (hard to implement with current Aerospace)
    ...
    # REVISIT: 2026-04-12: FIXABLE? cycle windows (hard to implement with current Aerospace)
