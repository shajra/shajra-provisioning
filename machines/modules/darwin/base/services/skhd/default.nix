...
in
{
  ...
  skhdConfig = ''
    ...
    # REVISIT: 2026-05-23: BLOCKED: Return all references to cmd back to lcmd
    ...
    # REVISIT: 2026-05-23: FIXABLE? move workspace (hard to implement with current Aerospace)
    ...
    # REVISIT: 2026-05-23: FIXABLE? cycle windows (hard to implement with current Aerospace)
