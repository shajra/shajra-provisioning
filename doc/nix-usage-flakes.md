...
```
    ...
    /nix/store/wkcr71mvnn86nb9cdanyfd019vcyp2gm-home-manager
...
```
    ...
    Usage: /nix/store/wkcr71mvnn86nb9cdanyfd019vcyp2gm-home-manager/bin/home-manager [OPTION] COMMAND
...
```
    ...
    /nix/store/wkcr71mvnn86nb9cdanyfd019vcyp2gm-home-manager/bin/home-manager
...
```
    ...
    Store paths:        /nix/store/wkcr71mvnn86nb9cdanyfd019vcyp2gm-home-manager
