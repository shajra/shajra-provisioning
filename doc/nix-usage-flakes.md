...
```
    ...
    /nix/store/xgs8zkq12ni2f03kr0f0yycadl9waf20-home-manager
...
```
    ...
    Usage: /nix/store/xgs8zkq12ni2f03kr0f0yycadl9waf20-home-manager/bin/home-manager [OPTION] COMMAND
...
```
    ...
    /nix/store/xgs8zkq12ni2f03kr0f0yycadl9waf20-home-manager/bin/home-manager
...
```
    ...
    Store paths:        /nix/store/xgs8zkq12ni2f03kr0f0yycadl9waf20-home-manager
