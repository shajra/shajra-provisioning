...
```
    ...
    /nix/store/chhzamxbwp70c7fi0v4cv7jw98s5mr5a-home-manager
...
```
    ...
    Usage: /nix/store/chhzamxbwp70c7fi0v4cv7jw98s5mr5a-home-manager/bin/home-manager [OPTION] COMMAND
...
```
    ...
    /nix/store/chhzamxbwp70c7fi0v4cv7jw98s5mr5a-home-manager/bin/home-manager
...
```
    ...
    Store paths:        /nix/store/chhzamxbwp70c7fi0v4cv7jw98s5mr5a-home-manager
