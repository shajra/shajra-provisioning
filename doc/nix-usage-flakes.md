...
```
    ...
    /nix/store/afsd51gx1ad0b8p33lmy6hi3s5l3sd3w-home-manager
...
```
    ...
    Usage: /nix/store/afsd51gx1ad0b8p33lmy6hi3s5l3sd3w-home-manager/bin/home-manager [OPTION] COMMAND
...
```
    ...
    /nix/store/afsd51gx1ad0b8p33lmy6hi3s5l3sd3w-home-manager/bin/home-manager
...
```
    ...
    Store paths:        /nix/store/afsd51gx1ad0b8p33lmy6hi3s5l3sd3w-home-manager
