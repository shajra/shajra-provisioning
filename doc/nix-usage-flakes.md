...
```
    ...
    * legacyPackages.x86_64-linux.wezterm (0-unstable-2026-01-08)
...
```
    ...
    /nix/store/j14xnsdlsqfi9b040r6y269cb9y7m4wx-home-manager
...
```
    ...
    Usage: /nix/store/j14xnsdlsqfi9b040r6y269cb9y7m4wx-home-manager/bin/home-manager [OPTION] COMMAND
...
```
    ...
    /nix/store/j14xnsdlsqfi9b040r6y269cb9y7m4wx-home-manager/bin/home-manager
...
```
    ...
    Store paths:        /nix/store/j14xnsdlsqfi9b040r6y269cb9y7m4wx-home-manager
