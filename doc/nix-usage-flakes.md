...
```
    ...
    /nix/store/32kp9apri442896vc08jwb4hignk8vyq-home-manager
...
```
    ...
    Usage: /nix/store/32kp9apri442896vc08jwb4hignk8vyq-home-manager/bin/home-manager [OPTION] COMMAND
...
```
    ...
    /nix/store/32kp9apri442896vc08jwb4hignk8vyq-home-manager/bin/home-manager
...
```
    ...
    Store paths:        /nix/store/32kp9apri442896vc08jwb4hignk8vyq-home-manager
