...
```
    ...
    /nix/store/3snpm3b1ahcbi5zys8lcrwhjlgfrgd6j-home-manager
...
```
    ...
    Usage: /nix/store/3snpm3b1ahcbi5zys8lcrwhjlgfrgd6j-home-manager/bin/home-manager [OPTION] COMMAND
...
```
    ...
    /nix/store/3snpm3b1ahcbi5zys8lcrwhjlgfrgd6j-home-manager/bin/home-manager
...
```
    ...
    Store paths:        /nix/store/3snpm3b1ahcbi5zys8lcrwhjlgfrgd6j-home-manager
