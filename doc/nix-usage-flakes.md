...
```
    ...
    * legacyPackages.x86_64-linux.wezterm (0-unstable-2026-01-09)
...
```
    ...
    /nix/store/pdry58avglc3cad4rczhhlic9yf67p22-home-manager
...
```
    ...
    Usage: /nix/store/pdry58avglc3cad4rczhhlic9yf67p22-home-manager/bin/home-manager [OPTION] COMMAND
...
```
    ...
    /nix/store/pdry58avglc3cad4rczhhlic9yf67p22-home-manager/bin/home-manager
...
```
    ...
    Store paths:        /nix/store/pdry58avglc3cad4rczhhlic9yf67p22-home-manager
